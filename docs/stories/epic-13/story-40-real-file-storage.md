...
## Tasks
-   [x] Create/Update `docker-compose.yml` with MinIO.
-   [x] Add MinIO Credentials to `.env.example`.
-   [x] Implement `S3StorageProvider` in `ShareService` targeting localhost.
-   [x] Verify Upload & Download.
